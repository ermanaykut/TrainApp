...
const VagonFour: React.FC<VagonProps> = ({activeIndex}) => {
  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.trainContainer}>
        ...
        <View style={styles.frontAndBackLuggageContainer}>
            <View style={styles.frontLeftLuggage}>
              <View style={styles.luggageRotation}>
                <Icon
            ...
            <View style={styles.frontRightluggage}>
              <View style={styles.luggageRotation}>
                <Icon
                  name="suitcase : fontisto"
                  size={20}
          ...
          <View style={styles.frontAndBackLuggageContainer}>
            <View style={styles.backLeftLuggage}>
              <View style={styles.luggageRotation}>
                <Icon
                  name="suitcase : fontisto"
                  size={20}
            ...
            <View style={styles.backRightluggage}>
              <View style={styles.luggageRotation}>
                <Icon
                  name="suitcase : fontisto"
                  size={20}
