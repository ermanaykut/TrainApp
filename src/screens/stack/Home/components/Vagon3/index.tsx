...
const VagonThree: React.FC<VagonProps> = ({activeIndex}) => {
          ...
          <View style={styles.verticalTextContainer3}>
            <Animated.View
              ...
              <Text style={styles.verticalText3} numberOfLines={1}>
                Economy Class -- Economy Class -- Economy Class -- Economy Class -- Economy Class -- Economy Class
              </Text>
            </Animated.View>
          </View>
          <FlatList
